...
# 📖 'School Data <a name="about-project"></a>

**School Data** is a begininng project aimed to help schools for saving and keeping student data.
...
- cd my-folder
- git clone https://github.com/husush23/My-trial-review.git
